var bdimsInfo ={
   ...
   "reference" : "Heinz G, Peterson LJ, Johnson RW, Kerk CJ. 2003. Exploring\nRelationships in Body Dimensions. Journal of Statistics Education 11(2).",
   "format" : "A data frame with 507 observations on the following 25 variables.",
   "title" : "Body measurements of 507 physically active individuals.",
   "parameters" : {
      "cal_gi" : "A numerical vector, respondent's calf maximum girth\nin centimeters, measured as average of right and left girths.",
      "bic_gi" : "A numerical vector, respondent's bicep girth in\ncentimeters, measured when flexed as the average of right and left\ngirths.",
      "bia_di" : "A numerical vector, respondent's biacromial diameter in\ncentimeters.",
      "age" : "A numerical vector, respondent's age in years.",
      "wri_gi" : "A numerical vector, respondent's wrist minimum girth\nin centimeters, measured as average of right and left girths.",
      "ank_gi" : "A numerical vector, respondent's ankle minimum girth\nin centimeters, measured as average of right and left girths.",
      "che_de" : "A numerical vector, respondent's chest depth in centimeters,\nmeasured between spine and sternum at nipple level, mid-expiration.",
      "wgt" : "A numerical vector, respondent's weight in kilograms.",
      "elb_di" : "A numerical vector, respondent's elbow diameter in\ncentimeters, measured as sum of two elbows.",
      "hgt" : "A numerical vector, respondent's height in centimeters.",
      "bii_di" : "A numerical vector, respondent's biiliac diameter\n(pelvic breadth) in centimeters.",
      "for_gi" : "A numerical vector, respondent's forearm girth in\ncentimeters, measured when extended, palm up as the average of right and\nleft girths.",
      "wri_di" : "A numerical vector, respondent's wrist diameter in\ncentimeters, measured as sum of two wrists.",
      "ank_di" : "A numerical vector, respondent's ankle diameter in\ncentimeters, measured as sum of two ankles.",
      "wai_gi" : "A numerical vector, respondent's waist girth in\ncentimeters, measured at the narrowest part of torso below the rib cage as\naverage of contracted and relaxed position.",
      "sex" : "A categorical vector, 1 if the respondent is male,\n0 if female.",
      "thi_gi" : "A numerical vector, respondent's thigh girth in\ncentimeters, measured below gluteal fold as the average of right and left\ngirths.",
      "kne_gi" : "A numerical vector, respondent's knee diameter in\ncentimeters, measured as sum of two knees.",
      "hip_gi" : "A numerical vector, respondent's hip girth in\ncentimeters, measured at at level of bitrochanteric diameter.",
      "bit_di" : "A numerical vector, respondent's bitrochanteric diameter\nin centimeters.",
      "nav_gi" : "A numerical vector, respondent's navel (abdominal)\ngirth in centimeters, measured at umbilicus and iliac crest using iliac\ncrest as a landmark.",
      "sho_gi" : "A numerical vector, respondent's shoulder girth in\ncentimeters, measured over deltoid muscles.",
      "che_di" : "A numerical vector, respondent's chest diameter in\ncentimeters, measured at nipple level, mid-expiration.",
      "kne_di" : "A numerical vector, respondent's knee diameter in\ncentimeters, measured as sum of two knees.",
      "che_gi" : "A numerical vector, respondent's chest girth in\ncentimeters, measured at nipple line in males and just above breast tissue\nin females, mid-expiration."
   }
}
