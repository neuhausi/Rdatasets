var GrunfeldInfo ={
   "usage" : "data(\"Grunfeld\")",
   "description" : "Description\nPanel data on 11 large US manufacturing firms over 20 years, for the years 1935&ndash;1954.",
   "title" : "Grunfeld's Investment Data",
   "format" : "A data frame containing 20 annual observations on 3 variables for 11 firms.",
   "reference" : "This is a popular data set for teaching purposes. Unfortunately, there exist several \ndifferent versions (see Kleiber and Zeileis, 2010, for a detailed discussion). \nIn particular, the version provided by Greene (2003) has a couple of errors\nfor \"US Steel\" (firm 2): \ninvestment in 1940 is 261.6 (instead of the correct 361.6), \ninvestment in 1952 is 645.2 (instead of the correct 645.5), \ncapital    in 1946 is 132.6 (instead of the correct 232.6).",
   "parameters" : {
      "firm" : "factor with 11 levels: \"General Motors\", \"US Steel\",\n\"General Electric\", \"Chrysler\", \"Atlantic Refining\", \"IBM\",\n\"Union Oil\", \"Westinghouse\", \"Goodyear\", \"Diamond Match\",\n\"American Steel\".",
