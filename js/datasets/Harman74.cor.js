...
var Harman74.cor = [
   [
      ...
      "cov.PaperFormBoard",
      "cov.Flags",
      "cov.GeneralInformation",
      "cov.PargraphComprehension",
      "cov.SentenceCompletion",
      "cov.WordClassification",
      "cov.WordMeaning",
      "cov.Addition",
      "cov.Code",
      "cov.CountingDots",
      "cov.StraightCurvedCapitals",
      "cov.WordRecognition",
      "cov.NumberRecognition",
      "cov.FigureRecognition",
      "cov.ObjectNumber",
      "cov.NumberFigure",
      "cov.FigureWord",
      "cov.Deduction",
      "cov.NumericalPuzzles",
      "cov.ProblemReasoning",
      "cov.SeriesCompletion",
      "cov.ArithmeticProblems",
      "center",
      "n.obs"
   ],
   [
