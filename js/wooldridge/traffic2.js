var traffic2Info ={
   ...
   "title" : "traffic2",
   "description" : "Description\nWooldridge Source: P.S. McCarthy (1994), âRelaxed Speed Limits and Highway Safety: New Evidence from California,â Economics Letters 46, 173-179. Professor McCarthy kindly provided the data. Data loads lazily.",
   "reference" : "Many states have changed maximum speed limits and imposed seat belt laws over the past 25 years. Data similar to those in TRAFFIC2.RAW should be fairly easy to obtain for a particular state. One should combine this information with changes in a stateâs blood alcohol limit and the passage of per se and open container laws.",
   "usage" : "data('traffic2')"
}
